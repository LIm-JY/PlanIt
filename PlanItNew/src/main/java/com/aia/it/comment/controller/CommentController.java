 ...
 * 
 * import com.aia.it.board.service.BoardListService; import
 * com.aia.it.comment.model.Comment; import
 * com.aia.it.comment.model.CommentRequest; import
 * com.aia.it.comment.service.CommentService;
 * 
 * @Controller
 * 
 * @RequestMapping("/comment/comment") public class CommentController {
 * 
 * 
 * @Autowired CommentService cService;
 * 
 * @Autowired BoardListService bService;
 * 
 * @RequestMapping(method = RequestMethod.GET) public String getCommentForm(
